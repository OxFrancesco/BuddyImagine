...
async def test_fal_service_generate_image():
    with patch("aiohttp.ClientSession") as MockSession:
        ...
        mock_get_response.read.return_value = b"image_bytes"
        
        # session.get() returns an async context manager
        mock_get_ctx = MagicMock()
        mock_get_ctx.__aenter__.return_value = mock_get_response
        ...
        service.cf_account_id = "fake"
        service.cf_gateway_id = "fake"
